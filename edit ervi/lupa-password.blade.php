      ...
      <section class="main-banner mv-wrap">
        <div data-image-src="images/background/demo_bg_1920x1680.png" class="mv-banner-style-1 mv-bg-overlay-dark overlay-0-85 mv-parallax">
          <div class="page-name mv-caption-style-6">
            <div class="container">
              <div class="mv-title-style-9"><span class="main">Lupa Password</span><img src="images/icon/icon_line_polygon_line.png" alt="icon" class="line"/></div>
            </div>
          </div>
        </div>
      </section>
                ...
                <form method="GET" class="form-forgot-password">
                  <div class="form-header">
                    <div class="mv-title-style-13">
                      ...
                      <div class="text-sub">Masukkan alamat email untuk mereset password. Jika tidak ada di kotak masuk, coba pastikan cek folder spam anda.</div>
                    </div>
                  </div>
                  <!-- .form-header-->
