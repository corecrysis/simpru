...
<!--                                        <option value="sarpras">Sarana dan Prasarana</option>-->
                            ...
                            <div class="form-group{{ $errors->has('select_fakultas') ? ' has-error' : '' }}" >
                                <label for="kategori" class="col-sm-2 control-label">Pilih Fakultas</label>
                                <div class="col-sm-10">

                                    <select class="form-control select2" id="select_fakultas" name="select_fakultas" style="width: 100%;" disabled required>
                            ...
                            <input type="hidden" name="pil-fakultas" id="pil-fakultas" value="0" disabled>
                            <input type="hidden" name="pil-fasilitas" id="pil-fasilitas" value="1000" disabled>
                            <div class="form-group{{ $errors->has('status_kategori') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="status_kategori" style="width: 100%;" required>
                                        <option selected="selected" value="">Pilih Status Kategori</option>
