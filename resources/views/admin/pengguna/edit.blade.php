        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" class="form-horizontal" action="/admin/pengguna/update/{{$pengguna->id_pengguna}}" method="post">
                        <div class="box-body">
                            
                            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" class="form-control" id="username" name="username" value="{{$pengguna->name}}" placeholder="Masukkan username" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('nrp_pengguna') ? ' has-error' : '' }}">
                                ...
                                <input type="number" class="form-control" id="nrp_pengguna" value="{{$pengguna->identifier}}" name="nrp_pengguna" placeholder="Masukkan NRP/NIK" required>
                            ...
                            <div class="form-group{{ $errors->has('no_hp') ? ' has-error' : '' }}">
                                ...
                                <input type="number" class="form-control" id="no_hp" value="{{$pengguna->no_hp}}" name="no_hp" placeholder="Masukkan No. HP" required>
                                @if ($errors->has('no_hp'))
                                <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('email_pengguna') ? ' has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" id="email_pengguna" name="email_pengguna" value="{{$pengguna->email}}" placeholder="Masukkan Email" required>
