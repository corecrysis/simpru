            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" class="form-horizontal" action="/admin/ruang/insert" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('nm_ruangan') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nm_ruangan" name="nm_ruangan"
                                               placeholder="Masukkan nama ruangan" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('detail_ruangan') ? ' has-error' : '' }}">
                                    ...
                                    <textarea class="textarea" id="detail_ruangan" name="detail_ruangan"
                                              ...
                                              style="width: 100%; height: 50px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
                                ...
                                <div class="form-group{{ $errors->has('id_kategori_ruangan') ? ' has-error' : '' }}">
                                    <label for="kategori_ruangan" class="col-sm-2 control-label">Kategori
                                        Ruangan</label>
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="id_kategori_ruangan"
                                                id="id_kategori_ruangan"
                                ...
                                <div class="form-group{{ $errors->has('status_ruangan') ? ' has-error' : '' }}">
                                    <label for="status_ruangan" class="col-sm-2 control-label">Status
                                        Ruangan</label>
                                    <div class="col-sm-10">
                                        <select class="form-control select2" id="status_ruangan"
                                                name="status_ruangan" style="width: 100%;" required>
