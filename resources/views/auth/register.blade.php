                        ...
                        <form method="POST" class="form-register" action="{{ route('register') }}">
                            ...
                            <div class="form-body">
                                <div class="mv-form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="mv-field">
                                        <input type="nama" name="name" value="{{ old('name') }}" class="mv-inputbox mv-inputbox-style-1"
                                               required/>
                                        @if ($errors->has('name'))
                                ...
                                <div class="mv-form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    <div class="mv-label"><strong class="text-uppercase">Email<span
                                                    class="mv-color-primary"> *</span></strong></div>
                                    <div class="mv-field">
                                        <input type="email" name="email"  value="{{ old('email') }}" class="mv-inputbox mv-inputbox-style-1"
                                               required/>
                                        @if ($errors->has('email'))
                                            <span class="help-block">
                                ...
                                <div class="mv-form-group{{ $errors->has('identifier') ? ' has-error' : '' }}">
                                    <div class="mv-label"><strong class="text-uppercase">No. KTP<span
                                                    class="mv-color-primary"> *</span></strong></div>
                                    <div class="mv-field">
                                        <input type="nama" name="identifier" value="{{ old('identifier') }}" class="mv-inputbox mv-inputbox-style-1"
                                               required/>
                                ...
                                <div class="mv-form-group{{ $errors->has('no_hp') ? ' has-error' : '' }}">
                                    <div class="mv-label"><strong class="text-uppercase">No. HP<span
                                                    class="mv-color-primary"> *</span></strong></div>
                                    <div class="mv-field">
                                        <input type="text" name="no_hp"  value="{{ old('no_hp') }}" class="mv-inputbox mv-inputbox-style-1"
                                               required/>
                                        @if ($errors->has('no_hp'))
                                            <span class="help-block">
                                ...
                                <div class="mv-form-group">
                                    ...
                                    <div class="mv-field">
                                        <input id="password-confirm" type="password" name="password_confirmation" class="mv-inputbox mv-inputbox-style-1"
                                               required/>
                                    </div>
                                </div>
